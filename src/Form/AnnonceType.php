...
class AnnonceType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('slug', TextType::class, $this->getConfiguration("Adresse web", "Tapez une super adresse", [
                'required' => false
            ]))
            ...
            ->add('content', TextareaType::class, $this->getConfiguration("Description détaillée", "Tapez une description qui donne vraiment envie de venr chez vous!"))
