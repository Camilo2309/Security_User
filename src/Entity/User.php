...
class User implements UserInterface
{
     ...
     * @var
     *
     * @Assert\EqualTo(propertyPath="hash", message="Vous n'avez pas corréctement confirmer votre mot de passe!")
     */
    ...
    // permet de supprimer des données confidentiels de l utilisateur
